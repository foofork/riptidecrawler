...
//!
//! This file is auto-generated by `wit-bindgen` for WASM Component Model FFI.
//!
//! ## Memory Management
//!
//! All `mem::forget` calls are REQUIRED by WASM ABI to prevent double-free
//! when transferring ownership across the host-guest boundary.
//!
//! **DO NOT MODIFY** - regenerate with: `wit-bindgen rust --out-dir src/ wit/extractor.wit`
