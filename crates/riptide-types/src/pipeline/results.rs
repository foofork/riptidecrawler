//! Pipeline result types - Moved from riptide-pipeline to break circular dependency
//!
//! These types define the public API contracts for pipeline execution results.
//! They are intentionally placed in riptide-types (the foundation layer) to allow
//! both riptide-api (implementation) and riptide-facade (application logic) to
