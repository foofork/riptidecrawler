...
//!
//! Moved from riptide-api/src/streaming/buffer.rs as part of Sprint 4.3 Phase 4
//! to properly organize infrastructure concerns in the hexagonal architecture.
...
impl DynamicBuffer {
    ...
    pub async fn record_send(&self, duration: Duration) -> BufferResult<()> {
    ...
    /// Adjust buffer size based on recent performance
    async fn adjust_buffer_size(&self) -> BufferResult<()> {
...
impl BackpressureHandler {
    ...
    pub async fn record_send_time(&mut self, duration: Duration) -> BufferResult<()> {
