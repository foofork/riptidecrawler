...
impl PdfiumProcessor {
    ...
    async fn process_pdf_enhanced(
        ...
        // RAII guard: Tracks active processors and performs memory cleanup on drop.
        // Must remain alive for the entire duration of PDF processing.
