//! Redis-based cache manager with HTTP caching support
//!
//! This module provides version-aware caching with conditional request support,
//! content validation, and comprehensive TTL management.
...
const DEFAULT_CACHE_TTL: u64 = 24 * 60 * 60;

/// Maximum content size (20MB)
const MAX_CONTENT_SIZE: usize = 20 * 1024 * 1024;
