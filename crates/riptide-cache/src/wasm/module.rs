...
//! ## Features
//!
//! - Global singleton cache for WASM extractors
//! - Lazy loading with configurable timeouts
//! - Automatic cache invalidation on path changes
//! - Usage statistics and cache monitoring
//!
//! ## Architecture
//!
//! The module cache maintains:
//! - **Single extractor instance** per path for memory efficiency
...
/// Singleton WASM cache for optimized executor integration
///
