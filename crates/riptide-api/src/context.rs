...
///
/// # Architecture
/// ApplicationContext follows the hexagonal architecture pattern where:
/// - Ports: Defined by the struct's public interface
/// - Adapters: Individual fields implementing infrastructure concerns
/// - Domain: Business logic remains separate from infrastructure
///
